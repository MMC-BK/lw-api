...
// UpdateInventoryItemRequest update inventory item request
//
// swagger:model UpdateInventoryItemRequest
type UpdateInventoryItemRequest struct {
	...
	InOrder int32 `json:"InOrder,omitempty"`
	...
	// shipped separately
	ShippedSeparately bool `json:"ShippedSeparately,omitempty"`
	...
	VariationGroupName string `json:"VariationGroupName,omitempty"`
...
// Validate validates this update inventory item request
func (m *UpdateInventoryItemRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UpdateInventoryItemRequest) validateCategoryID(formats strfmt.Registry) error {
...
func (m *UpdateInventoryItemRequest) validateCreationDate(formats strfmt.Registry) error {
...
func (m *UpdateInventoryItemRequest) validatePackageGroupID(formats strfmt.Registry) error {
...
func (m *UpdateInventoryItemRequest) validatePostalServiceID(formats strfmt.Registry) error {
...
func (m *UpdateInventoryItemRequest) validateStockItemID(formats strfmt.Registry) error {
...
// ContextValidate validate this update inventory item request based on the context it is used
func (m *UpdateInventoryItemRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *UpdateInventoryItemRequest) contextValidateAvailable(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UpdateInventoryItemRequest) contextValidateIsBatchedStockType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UpdateInventoryItemRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *UpdateInventoryItemRequest) UnmarshalBinary(b []byte) error {
	var res UpdateInventoryItemRequest
