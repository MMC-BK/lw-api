...
// Validate validates this stock item
func (m *StockItem) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *StockItem) validateCategoryID(formats strfmt.Registry) error {
...
func (m *StockItem) validateCreationDate(formats strfmt.Registry) error {
...
func (m *StockItem) validatePackageGroupID(formats strfmt.Registry) error {
...
func (m *StockItem) validatePostalServiceID(formats strfmt.Registry) error {
...
func (m *StockItem) validateStockItemID(formats strfmt.Registry) error {
...
// ContextValidate validate this stock item based on the context it is used
func (m *StockItem) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *StockItem) contextValidateAvailable(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StockItem) contextValidateIsBatchedStockType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StockItem) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StockItem) UnmarshalBinary(b []byte) error {
	var res StockItem
