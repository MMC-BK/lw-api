...
// StockItemInv stock item inv
//
// swagger:model StockItemInv
type StockItemInv struct {
...
// Validate validates this stock item inv
func (m *StockItemInv) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *StockItemInv) validateCategoryID(formats strfmt.Registry) error {
...
func (m *StockItemInv) validateCreationDate(formats strfmt.Registry) error {
...
func (m *StockItemInv) validatePackageGroupID(formats strfmt.Registry) error {
...
func (m *StockItemInv) validatePostalServiceID(formats strfmt.Registry) error {
...
func (m *StockItemInv) validateStockItemID(formats strfmt.Registry) error {
...
// ContextValidate validate this stock item inv based on the context it is used
func (m *StockItemInv) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *StockItemInv) contextValidateAvailable(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StockItemInv) contextValidateIsBatchedStockType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StockItemInv) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StockItemInv) UnmarshalBinary(b []byte) error {
	var res StockItemInv
