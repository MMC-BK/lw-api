...
// OrderNoteDto order note dto
//
// swagger:model OrderNoteDto
type OrderNoteDto struct {
...
// Validate validates this order note dto
func (m *OrderNoteDto) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OrderNoteDto) validateNoteDate(formats strfmt.Registry) error {
...
func (m *OrderNoteDto) validateOrderID(formats strfmt.Registry) error {
...
func (m *OrderNoteDto) validateOrderNoteID(formats strfmt.Registry) error {
...
// ContextValidate validates this order note dto based on context it is used
func (m *OrderNoteDto) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *OrderNoteDto) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OrderNoteDto) UnmarshalBinary(b []byte) error {
	var res OrderNoteDto
